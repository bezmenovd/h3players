...
На данный момент собираются и сохраняются только завершенные рейтинговые игры, которые могут быть получены через просмотр истории игр игрока (начиная с 27.06.2023)

Аккаунты, принадлежащие h3players.com: 
